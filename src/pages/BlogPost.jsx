...
export default function BlogPost() {
  ...
  if (!post) {
    const indexalPost = findIndexalPost('es', slug);
    if (indexalPost) {
      const translation = translationFor(indexalPost, 'en');
      return <IndexalArticle post={indexalPost} blogHref="/blog" translationHref={translation ? `/en/blog/${translation.slug}` : null} />;
    }
    return <NotFound />;
  }
